...
$applications=fetch_img($db, $tableName, $columns, "where type='applications'");
$sustain_main=fetch_img($db, $tableName, $columns, "where type='sustain_main'");
$sustain=fetch_img($db, $tableName, $columns, "where type='sustain'");
